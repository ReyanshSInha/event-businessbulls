import engifest from "../Assets/9dedfab832f2fabaf5ac7cc50abf939c.jpeg"
...
const EventScroll = () => {
    ...
    return <div className="h-[70vh] flex justify-center bg-[#0f0f0f] w-full">
            <div className="w-[70%] relative rounded-2xl h-[28.2rem]">
                <img className=" h-full w-full " src={engifest}/>
                ...
                <img src={arrow} className="absolute top-[210px] left-[22px]" />
                <img src={arrow} className="absolute top-[210px] rotate-180 right-[22px]" />
